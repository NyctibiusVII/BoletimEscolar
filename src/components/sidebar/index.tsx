                                                ...
                                                <div key={index} className='w-full flex items-center justify-between even:bg-shadow-5 dark:even:bg-shadow-15 rounded-md p-1 last:even:mb-3'>
                                                    ...
                                                    <div className='flex flex-nowrap'>
                                                        ...
                                                        <button
                                                            ...
                                                            className='w-7 h-7 hover:bg-red-400 text-red-400 hover:text-white p-1 flex items-center justify-center rounded-md'
                                                        >
                                ...
                                <div className='max-h-[20rem] overflow-auto'>
                                                ...
                                                <div className='flex gap-2'>
                                                    { isCustomSubject &&
                                                        <button
                                                            ...
                                                            className='w-8 h-8 bg-shadow-5 dark:bg-shadow-15 border border-transparent hover:border-violet-500 flex items-center justify-center p-1 rounded-md'
                                                            title={`Remover a matéria ${subject}`}
                                                            aria-label={`Remover a matéria ${subject}`}
                                                        >
                                                    ...
                                                    <button
                                                        ...
                                                        className='w-8 h-8 bg-shadow-5 dark:bg-shadow-15 border border-transparent hover:border-violet-500 flex items-center justify-center p-1 rounded-md disabled:opacity-40 disabled:hover:border-transparent disabled:cursor-not-allowed'
                                    ...
                                    <div className='w-full hover:bg-shadow-5 hover:dark:bg-shadow-15 flex items-center justify-between gap-2 py-1 px-3 rounded-md'>
                                        ...
                                        <button
                                            ...
                                            className='w-14 h-7 bg-green-400 hover:bg-green-500 focus:bg-green-600 flex items-center justify-center p-1 rounded-md disabled:opacity-40 disabled:hover:bg-green-400 disabled:cursor-not-allowed'
                                            disabled={subjects.length >= 12}
